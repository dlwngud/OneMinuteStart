...
sealed class Screen(
    ...
    object OneMinuteScreen : Screen("oneMinuteScreen/{id}", "", -1) {
        fun createRoute(id: Long) = "oneMinuteScreen/$id"
    }
    object MoreScreen : Screen("moreScreen/{id}", "", -1) {
        fun createRoute(id: Long) = "moreScreen/$id"
    }
}